...
const DIMS = [
  {
    ...
    assessment: [
      ...
      { q: "Physical tension in my body has reduced over the past 30 days", scale: true },import { useState, useEffect, useRef } from "react";
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0A0A08", color: "#E8E2D6", fontFamily: "'Georgia', serif" }}>
      ...
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "40px 32px" }} className="fade">
        ...
        {view === "framework" && (
          <div>
            {activeDim !== null && <button className="nav-btn" onClick={() => setActiveDim(null)} style={{ marginBottom: 24, paddingLeft: 0 }}>← all dimensions</button>}
            {!dim ? (
              <div>
